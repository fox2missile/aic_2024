...
public class DbConst {
    ...
    public final int SYMMETRIC_SEEKER_COMPLETE_FOUND_SYMMETRY = 4;
    public final int SYMMETRIC_SEEKER_COMPLETE_STATUS_MASKER = 0x0000000F;
    public final int SYMMETRIC_SEEKER_COMPLETE_SYMMETRY_MASKER = 0x000000F0;
    public final int SYMMETRIC_SEEKER_SYMMETRY_MASK_SHIFT = 4;
